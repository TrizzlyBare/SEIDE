...
const Button = styled.button`
  ...
  border-radius: 4px;
  cursor: pointer;
  &:hover { background: ${props => props.$primary ? '#1557b0' : '#555'}; }
                ...
                >
                  ...
                  {testCase.setup_script && (
                    <div style={{ marginTop: '8px' }}>
                      ...
                      <pre style={{ background: '#f1f1f1', padding: '8px', marginTop: '4px', borderRadius: '4px' }}>
                        {testCase.setup_script}
                      </pre>
                    </div>
                  )}
        ...
        <Overlay onClick={() => setIsModalOpen(false)}>
          <Modal onClick={e => e.stopPropagation()}>
            ...
            <form onSubmit={handleAddQuestion}>
              ...
              <Button type="button" onClick={() => setNewQuestion({
                ...newQuestion,
